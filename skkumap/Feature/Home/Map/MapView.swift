...
//                        let contentState = BusArrivalAttributes.ContentState(value: 7000, step: 0, message: "test")
//                        do {
...
struct MapView: View {
    ...
    // 처음 시작할때 하단 sheet 확장 얼마나 되게 할지 결정
            ...
            VStack(alignment: .leading){
                ...
                HStack(alignment: .center, spacing: 5) {
                    ...
                    // 기본 spacing이 10이기 때문에 15-5=10만큼만 width 주면 된다
                            ...
                            SearchIconsView(showBorder: true, showArrow: true, imageName: "subway", imageType: .photo, iconColor: .black, text: "건물지도", url: URL(string: "https://www.example.com"))
                            
                            SearchIconsView(showBorder: false, imageName: "map", imageType: .icon, iconColor: .black, text: "캠퍼스지도", url: URL(string: "https://www.example.com"))
                    
                            SearchIconsView(showBorder: false, imageName: "person.text.rectangle", imageType: .icon, iconColor: .black, text: "킹고패스", url: URL(string: "https://www.example.com"))
                    
                            SearchIconsView(showBorder: false, imageName: "bag", imageType: .icon, iconColor: .black, text: "분실물", url: URL(string: "https://www.example.com"))
...
//                SearchIconsView()
            ...
            DraggableView(currentPage: $currentPage)
